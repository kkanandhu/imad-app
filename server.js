...
var config = "pool://kkanandhu97:process.env.DB_PASSWORD@localhost:5432/kkanandhu97";
var app = express();
...
/*var articles={
 'article-one':{ 
    ...
    heading:'article one',
    date:'sept 5 2017',
    content: `<h3> Dulquer Salmaan (born 28 July 1986)</h3>
        <p1>Dulquer Salmaan (born 28 July 1986),
 ...
 'article-three':{
    ...
    date:'sept 5 2017',
    content: `      <h3> Ajith Kumar (born 1 May 1971)</h3>
                    <p1>
